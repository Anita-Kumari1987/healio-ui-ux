        ...
        <div className="doctor-update">
          ...
          <div className="doctor-container">
            ...
            <div className="testimonial">
              <p>
                "Great job on staying committed to your health! Your dedication
                to following through with your care plan is truly commendable.
                Keep up the great work, and don't hesitate to reach out if you
                need any guidance moving forward!"
              </p>
              <h4>- Doctor Drizzy</h4>
            </div>
          </div>
          ...
          <button className="information">
            <div className="information-content">
              ...
              <div>
                ...
                <div className="information-subtitle">
                  Get fast help from your specialists
                </div>
              </div>
              <div className="arrow">
                <ArrowContent width="25" height="14" color="black" />
